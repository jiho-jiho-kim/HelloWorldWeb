...
public class UserController {
	...
	public String main(Model model) {
		...
		model.addAttribute("address", "경기도 의정부");
	...
	public String register(HttpServletRequest request, Model model) {
		...
		model.addAttribute("gender", request.getParameter("gender"));   //변수하나에 값 하나 들어오니까 여러개 들어오는거면 values 해야함
	...
	public String register1(@RequestParam("userid") String userid, 
		...
		model.addAttribute("gender", gender);   //변수하나에 값 하나 들어오니까 여러개 들어오는거면 values 해야함
		return "register";  // /WEB-INF/views/ + register + .jsp
	}
	...
	@RequestMapping(value ="/register4/{userid}/{passwd}/{username}/{userage}/{gender}", 
